...
impl NativeBackend for CudaNativeSim {
    ...
    unsafe fn set_fftw_plans(&mut self, _lib_path: *const c_char, _n_time: size_t, _n_time_over: size_t, _is_real: c_int, _flags: c_uint, _wisdom_path: *const c_char) -> i32 {
        0 // Replaced by cuFFT
    }
    ...
    unsafe fn set_raman_fft_params(&mut self, _omega: *const c_double, _amp: *const c_double, _gauss_w: *const c_double, _lorentz_w: *const c_double, _n_osc: size_t, _scale: c_double, _dt: c_double, _n_time: size_t, _density: c_double) -> i32 { -1 }
